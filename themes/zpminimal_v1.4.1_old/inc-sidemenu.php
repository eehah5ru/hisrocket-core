				...
				<div id="sidemenu">
					...
					<ul id="nav">
						...
						<li <?php if ($_zp_gallery_page == "news.php") { ?>class="active" <?php } ?>>
							...
							<?php if ($_zp_gallery_page == "news.php") { printAllNewsCategories('',true,'','active',true,'','active','list',true); } ?>
						</li>
						<?php } ?>
						<?php if (function_exists('printPageMenu')) { printPageMenu('list','','active','','active','',true,false); } ?>
